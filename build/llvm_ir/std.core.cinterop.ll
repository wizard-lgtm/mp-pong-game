...
@"$ct.std.core.cinterop.CBool" = linkonce global { i8, i64, ptr, i64, i64, i64, [2 x %"char[]"] } { i8 8, i64 0, ptr null, i64 4, i64 ptrtoint (ptr @"$ct.int" to i64), i64 2, [2 x %"char[]"] [%"char[]" { ptr @.enum.FALSE, i64 5 }, %"char[]" { ptr @.enum.TRUE, i64 4 }] }, comdat, align 8
...
!2 = !DIFile(filename: "cinterop.c3", directory: "/home/ashly/Downloads/c3-linux/c3/lib/std/core")
